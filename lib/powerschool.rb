...
class Powerschool
  ...
  get :school_teachers, :ws, '/school/:school_id/staff?expansions=emails,phones'
  get :school_students, :ws, '/school/:school_id/student?expansions=addresses,phones,contact,contact_info,school_enrollment'
